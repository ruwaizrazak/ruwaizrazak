...
I first came across the idea of a decentralized web in 2015, through ~[Mozilla Story 2012](https://www.youtube.com/watch?v=Pzj-h7gzn_c&t=1s)~, while volunteering as a *Firefox Student Ambassador*. That exposure made me rethink how I was using the internet at the time (~[Social Media, an Ally](https://beingrez.blogspot.com/2015/03/social-media-ally.html)~), which eventually led me to ~[quit Facebook](https://beingrez.blogspot.com/2015/11/why-i-quit-facebook.html)~.

At the same time, I was experimenting with my own online spaces. I ran a ~[Blogger site](https://beingrez.blogspot.com/)~ that later evolved into Jekyll and then Hugo. But somewhere along the way, I drifted. Instead of posting casually, I moved to ~[Medium](https://medium.com/@ruwaizrazak)~, where writing started to feel different. It was less about capturing ideas, more about performing for an audience.
...
That silence made me step back and recognize the bigger pattern, mainstream platforms weren’t just hosting my writing, they were shaping it along with what I consumed and even how I thought (~[watch The Social Dilemma](https://www.netflix.com/watch/81254224?source=35)~).
...
Platforms like ~[Mastodon](https://mastodon.social/@ruwaizrazak)~ and ~[Bluesky](https://bsky.app/profile/ruwaizrazak.bsky.social)~ gives me that freedom. My content isn’t locked into one place, and I can connect across the web through systems like the Fediverse and Webmentions. 
...
With those values in mind, I started thinking about how to write again. Since October 2024, I’ve wanted a system that lets me capture ideas casually, while also giving me room to dig deeper when I need to. That search led me to the concept of ~[digital gardens](https://hackernoon.com/what-is-a-digital-garden), a rabbit hole I’ll definitely explore in a future post.
