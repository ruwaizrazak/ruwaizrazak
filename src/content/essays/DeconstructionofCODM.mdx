...
<Image src="/essays/DeconstructingCODM/DownloadsRevenue.webp" />
...
The above mentioned is an over simplification of Hook's model. If you are interested in learning more about the model, read <Link href="https://www.nirandfar.com/how-to-manufacture-desire/">the Man himself on how to manufacture desire</Link>
...
The paper on the model is very detailed and can be referred to in <Link href="https://drive.google.com/file/d/19LYba4fuceGM3KhqxTXByV4msmb33t1o/view?usp=sharing">the full paper</Link>
...
<Quote author="Saunders & Novak" source="2007">
Without conveying to the player the state of the game, there is no game.
</Quote>
...
With the introduction of these modes, what the developers have essentially done is to create a system that would initially cater the novice player and then to their improved versions who managed to master the controls over a period of time. (*Read more about <Link href="https://www.nngroup.com/articles/power-law-learning/">the power law of learning</Link>* and <Link href="https://www.nngroup.com/articles/usability-heuristics-applied-video-games/">usability heuristics applied to video games</Link>)
