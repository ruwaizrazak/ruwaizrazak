...
import ImagesLeft from '../../components/mdxComponents/ImagesLeft.svelte';
import TargetAudience from '../../components/mdxComponents/targetedAudience.svelte';
import SideBySide from '../../components/mdxComponents/sideBySide.svelte';
import SideNote from '../../components/mdxComponents/SideNote.svelte';
import References from '../../components/mdxComponents/references.svelte';
...
In the <Link href="https://www.deconstructoroffun.com/blog/2019/11/20/how-call-of-duty-mobile-left-100m-on-the-table">analysis in Deconstructors of fun</Link>, it was stated that the game have an enormous number of downloads in the initial week but not a good number of revenue per download since launch when compared to its competitor PUBG.
...
The above mentioned is an over simplification of Hook's model. If you are interested in learning more about the model, read from the Man himself <Link href="https://www.nirandfar.com/how-to-manufacture-desire/">here</Link>
...
**Targeted Behaviour = f(Motivation · Ability · Trigger)**
...
The paper on the model is very detailed and can be referred <Link href="https://drive.google.com/file/d/19LYba4fuceGM3KhqxTXByV4msmb33t1o/view?usp=sharing">here</Link>
...
### Aesthetics
Do you know that users often perceive aesthetically pleasing design as a design that's more usable? Okay, I didnt say that, but <Link href="https://lawsofux.com/aesthetic-usability-effect/">Aesthetic Usability Effect</Link> did.
...
While the game looks astonishing, the developers also considered about making the game accessible to <Link href="https://developer.samsung.com/galaxy-gamedev/gamedev-blog/cod.html">mid/low level performance</Link> devices and provides controls to users over graphics.
...
<Image src="https://i.imgur.com/JrDzpXH.png" alt="Multi-finger claw layouts used by competitive CODM players" />
...
<SideNote>This study is conducted by Iposos Morisaki, a researcher at Iposos. There is an interesting blog on how video games helped people to connect and engage during the times of COVID-19. <Link href="https://healthpolicy-watch.news/video-games-helps-people-to-connect/#:~:text=Supportive%20Role%20of%20Video%20Games%20During%20the%20Pandemic&text=Around%2030%25%20of%20surveyed%20players,50%25%20with%20multiplayer%20online%20games.">Read more here</Link></SideNote>
<Image src="/essays/DeconstructingCODM/GamesDuringPandemic.png" />

<SideNote>Here is a beautiful study if you love to <Link href="https://www.sciencedirect.com/science/article/pii/S0747563223002029">learn more about the social aspects in games</Link> </SideNote>
...
<SideNote> Here is the link to the original report <Link href="https://sensortower.com/blog/call-of-duty-mobile-shoots-past-usd1-5-billion-in-lifetime-player-spending">Sensor Tower</Link> </SideNote>
