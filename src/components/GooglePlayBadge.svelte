...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#fff" class="inline mr-2 flex-shrink-0" viewBox="0 0 64 64" aria-hidden="true">
  ...
  <div class="text-left">
    <p class="text-[10px] text-white leading-none font-medium">Get it on</p>
